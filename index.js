...
async function enter_move(board) {
...
async function draw_move(board) {
...
async function list_of_free_field(board) {
    let free = [];
...
async function victory_for(board) {
    for (var i = 0; i < 3; i++) {
        // horizontal Checks
...
async function main() {
    while (true) {
        const freeFields = await list_of_free_field(board);
